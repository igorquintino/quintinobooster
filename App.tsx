  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-white/90 backdrop-blur-md py-4 shadow-md border-b border-slate-100'
          : 'bg-transparent py-6'
      }`}
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-red-600 rounded-lg flex items-center justify-center font-bold text-xl text-white">
            Q
          </div>
          <span className="font-bold text-xl tracking-tight uppercase text-slate-900">
            QUINTINO <span className="text-red-600 font-black">BOOSTER</span>
          </span>
        </div>

        <div className="hidden md:flex items-center gap-8 font-semibold">
          <a href="#problema" className="text-slate-600 hover:text-red-600 transition-colors">
            O Problema
          </a>
          <a href="#solucao" className="text-slate-600 hover:text-red-600 transition-colors">
            A Solução
          </a>
          <a href="#metodo" className="text-slate-600 hover:text-red-600 transition-colors">
            O Método
          </a>
          <a href="#garantia" className="text-slate-600 hover:text-red-600 transition-colors">
            Garantia
          </a>
          <a
            href="https://pay.kiwify.com.br/d9puKrg"
            className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-full font-bold transition-all shadow-lg shadow-red-900/10"
          >
            Garantir Minha Vaga
          </a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white absolute top-full left-0 right-0 p-6 flex flex-col gap-6 border-b border-slate-100 shadow-xl">
          ...
          <a
            href="https://pay.kiwify.com.br/d9puKrg"
            className="bg-red-600 text-white px-6 py-4 rounded-xl text-center font-bold"
          >
            Garantir Minha Vaga
          </a>
        </div>
...
const Hero: React.FC = () => {
  // ✅ USE LINKS DIRETOS DE IMAGEM (ex: i.imgur.com/ID.png) OU SUA PASTA /public
    ...
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-2xl text-slate-600 max-w-3xl mx-auto mb-12 font-medium">
          Acompanhamento prático e individual focado 100% em contratação. Se você não for contratado em 6 meses seguindo o
          plano,{' '}
          <span className="text-slate-900 font-bold border-b-2 border-red-600">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
          <a
            href="https://pay.kiwify.com.br/d9puKrg"
            className="w-full md:w-auto bg-red-600 hover:bg-red-700 text-white px-12 py-6 rounded-2xl font-black text-xl shadow-2xl shadow-red-200 transition-all flex items-center justify-center gap-2 group"
          >
...
const PainPoints: React.FC = () => (
  <section id="problema" className="py-24 bg-slate-50">
    <div className="container mx-auto px-6 text-center mb-16">
      <h2 className="text-3xl md:text-5xl font-black mb-6 uppercase text-slate-900">
        POR QUE A MAIORIA <br />
        DOS INICIANTES <span className="text-red-600">ESTÁ DESEMPREGADA?</span>
      </h2>
      <p className="text-slate-600 text-xl max-w-2xl mx-auto font-medium">
        O mercado não está saturado, ele está saturado de pessoas que estudam do jeito errado.
      </p>
    </div>
    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {[
        {
          title: 'Círculo infinito de cursos',
          desc: 'Você vê 1000 horas de vídeo-aula mas não consegue criar um projeto sozinho.',
          icon: <Rocket className="text-red-600" />,
        },
        {
          title: 'Ghosting em processos',
          desc: 'Você aplica para centenas de vagas e seu currículo nem sequer é aberto pela triagem.',
          icon: <FileSearch className="text-red-600" />,
        },
        {
          title: 'Falta de portfólio real',
          desc: 'Seus projetos são cópias de tutoriais genéricos que não provam nada para o RH.',
          icon: <Target className="text-red-600" />,
        },
        {
          title: 'Síndrome do Impostor',
          desc: 'Você não tem um mentor experiente para validar seu conhecimento e te dar segurança.',
          icon: <Users className="text-red-600" />,
        },
      ].map((item, idx) => (
        <div
          key={idx}
          className="bg-white border border-slate-200 p-10 rounded-3xl hover:border-red-600/50 hover:shadow-xl transition-all group"
        >
      ...
      <div className="flex flex-col lg:flex-row items-center gap-20">
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-slate-600 mb-10 leading-relaxed font-medium">
            Esqueça cursos de vídeo gravado. A Quintino Booster é focada na <strong>sua contratação rápida.</strong>{' '}
            Dominamos os 3 pilares decisivos:
          </p>
...
const StepByStep: React.FC = () => (
  <section id="metodo" className="py-24 bg-slate-50">
    <div className="container mx-auto px-6 text-center mb-20">
      <h2 className="text-3xl md:text-5xl font-black mb-6 uppercase tracking-tighter text-slate-900">
        O MAPA DA MINA <span className="text-red-600">PASSO A PASSO</span>
      </h2>
      <p className="text-slate-600 text-xl max-w-2xl mx-auto font-medium">
        Direto ao ponto, sem enrolação e focado na prática real do mercado.
      </p>
    </div>
    ...
    <div className="container mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          {
            step: '01',
            title: 'Mentoria de Nivelamento',
            desc: 'Identificamos seus pontos fracos e criamos a base sólida necessária para o mercado sênior.',
            icon: <Target />,
          },
          {
            step: '02',
            title: 'Foco nas Techs Certas',
            desc: 'Você estuda apenas o que as empresas estão contratando hoje, nada de tecnologias mortas.',
            icon: <Rocket />,
          },
          {
            step: '03',
            title: 'Construção de Autoridade',
            desc: 'Seu GitHub deixará de ser um cemitério de projetos para se tornar sua melhor vitrine.',
            icon: <Zap />,
          },
          {
            step: '04',
            title: 'LinkedIn Hunter',
            desc: 'Transformamos seu perfil em um imã que atrai abordagens de recrutadores diariamente.',
            icon: <FileSearch />,
          },
          {
            step: '05',
            title: 'Simulado de Guerra',
            desc: 'Treinamos cada resposta para que você chegue na entrevista com a vaga praticamente garantida.',
            icon: <MessageSquare />,
          },
          {
            step: '06',
            title: 'Suporte Pós-Contrato',
            desc: 'Te ajudo a brilhar nos primeiros 90 dias para que você seja efetivado com louvor.',
            icon: <CheckCircle />,
          },
        ].map((item, idx) => (
          <div
            key={idx}
            className="relative p-10 rounded-3xl border border-slate-200 bg-white hover:shadow-2xl transition-all group"
          >
  ...
  <section id="garantia" className="py-24 bg-white">
    <div className="container mx-auto px-6">
      <div className="bg-red-600 p-10 md:p-20 rounded-[50px] text-center relative overflow-hidden shadow-[0_20px_60px_-15px_rgba(220,38,38,0.3)]">
        ...
        <h2 className="text-4xl md:text-7xl font-black mb-10 uppercase tracking-tighter text-white leading-tight">
          VOCÊ CONTRATADO EM 6 MESES <br />
          OU 100% DO REEMBOLSO.
        </h2>

        <p className="text-xl md:text-3xl text-red-50 max-w-4xl mx-auto mb-14 leading-relaxed font-medium">
          O risco é todo meu. Se você seguir o método e não conquistar sua primeira vaga em até 6 meses, eu te devolvo
          todo o valor investido{' '}
          <span className="underline decoration-white underline-offset-8">imediatamente</span>.
          <br />
          <br />
          <span className="bg-white text-red-600 px-8 py-3 rounded-full text-lg font-black uppercase inline-block shadow-xl">
...
const Testimonials: React.FC = () => (
  <section className="py-24 bg-white">
    <div className="container mx-auto px-6 text-center mb-20">
      <h2 className="text-3xl md:text-6xl font-black mb-6 uppercase tracking-tighter text-slate-900">
        O SUCESSO DE <span className="text-red-600">NOSSOS ALUNOS</span>
      </h2>
    ...
    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
      {[
        ...
        <div
          key={idx}
          className="bg-slate-50 p-10 rounded-[40px] border border-slate-200 relative hover:bg-white hover:shadow-2xl transition-all group"
        >
          ...
          <div className="flex items-center gap-5 pt-8 border-t border-slate-200">
            <img
              src={item.img}
              className="w-16 h-16 rounded-full border-2 border-red-600 p-1 object-cover"
              alt={item.name}
              loading="lazy"
            />
            <div>
...
const FinalCTA: React.FC = () => (
  <section className="py-32 relative bg-white">
    <div className="container mx-auto px-6 text-center">
      <h2 className="text-5xl md:text-8xl font-black mb-10 uppercase tracking-tighter text-slate-900">
        AS VAGAS SÃO <span className="text-red-600 underline">INDIVIDUAIS</span>.
      </h2>

      <p className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto mb-16 leading-relaxed font-medium">
        Eu não atendo turmas gigantes. Atendo <span className="text-slate-900 font-bold">seres humanos individuais.</span>{' '}
        Por isso as vagas esgotam rápido. Não deixe para o próximo semestre.
      </p>
  ...
  <footer className="py-20 border-t border-slate-100 bg-slate-50">
    <div className="container mx-auto px-6">
      <div className="flex flex-col md:flex-row justify-between items-center gap-10 text-center md:text-left">
        <div>
          <div className="flex items-center justify-center md:justify-start gap-3 mb-6">
            <div className="w-10 h-10 bg-red-600 rounded-xl flex items-center justify-center font-bold text-xl text-white shadow-lg">
              Q
            </div>
            <span className="font-black text-2xl tracking-tighter uppercase text-slate-900">
              QUINTINO <span className="text-red-600">BOOSTER</span>
            </span>
          </div>
      ...
      <div className="mt-16 pt-8 border-t border-slate-200 text-center">
        <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">© 2026 Quintino Booster. Todos os direitos reservados.</p>
      </div>
    </div>
  </footer>
);
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-red-600 selection:text-white">
      ...
      <div className="md:hidden fixed bottom-6 left-6 right-6 z-40">
        <a
          href="https://pay.kiwify.com.br/d9puKrg"
          className="bg-red-600 text-white w-full py-5 rounded-2xl font-black text-lg flex items-center justify-center gap-3 shadow-2xl border-2 border-white/20 uppercase"
        >
